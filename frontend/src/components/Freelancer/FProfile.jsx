  ...
  return (
    <div className="freelanceDetail freelanceProfile">
      ...
      <div className="briefDetails">
        <fetcher.Form method="PUT" className="block1" action={`${process.env.REACT_APP_BACKEND_URI}/freelancer/${formData.UserName}/profile`}>
          <div>
        ...
        <fetcher.Form method="DELETE" action={`${process.env.REACT_APP_BACKEND_URI}/freelancer/${formData.UserName}/profile`}>
